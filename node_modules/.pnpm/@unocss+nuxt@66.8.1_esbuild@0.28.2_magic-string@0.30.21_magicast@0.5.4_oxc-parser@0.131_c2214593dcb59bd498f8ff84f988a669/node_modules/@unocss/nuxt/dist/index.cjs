...
_unocss_preset_attributify = __toESM(_unocss_preset_attributify, 1);
let _unocss_preset_icons = require("@unocss/preset-icons");
_unocss_preset_icons = __toESM(_unocss_preset_icons, 1);
let _unocss_preset_tagify = require("@unocss/preset-tagify");
_unocss_preset_tagify = __toESM(_unocss_preset_tagify, 1);
let _unocss_preset_typography = require("@unocss/preset-typography");
_unocss_preset_typography = __toESM(_unocss_preset_typography, 1);
let _unocss_preset_web_fonts = require("@unocss/preset-web-fonts");
_unocss_preset_web_fonts = __toESM(_unocss_preset_web_fonts, 1);
let _unocss_preset_wind3 = require("@unocss/preset-wind3");
_unocss_preset_wind3 = __toESM(_unocss_preset_wind3, 1);
let _unocss_preset_wind4 = require("@unocss/preset-wind4");
_unocss_preset_wind4 = __toESM(_unocss_preset_wind4, 1);
//#region ../../virtual-shared/integration/src/defaults.ts
const defaultPipelineExclude = [require("@unocss/core").cssIdRE];
//#endregion
...
`;
		...
		nuxt.hook("build:before", async () => {
			...
			if (((0, _nuxt_kit.isNuxtMajorVersion)(3, nuxt) || (0, _nuxt_kit.isNuxtMajorVersion)(4, nuxt)) && nuxt.options.builder === "@nuxt/vite-builder" && nuxt.options.postcss.plugins.cssnano && unoConfig.transformers?.some((t) => t.name === "@unocss/transformer-directives" && t.enforce !== "pre")) {
